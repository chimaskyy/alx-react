...
describe("Test for Notifications.js", () => {
  ...
  it("should have thecurrect result", () => {
     const results = [
      ...
      expect(normalizedData.result).toEqual(results);
  })
  ...
  it("Has correct users entity", () =>{
    ...
    expect(normalizedData.entities.users["5debd764a7c57c7839d722e9"]).toEqual(results);
  })
